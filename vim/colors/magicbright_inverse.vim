...
let g:colors_name = "MagicBright_Inverse"
hi Normal ctermfg=236 ctermbg=Black guifg=#333333 guibg=White
...
hi Title ctermfg=65 gui=bold guifg=Green
hi Underlined ctermfg=4 guifg=#cccc00
...
call system('cp ~/.config/powerline/colors-inverted.json ~/.config/powerline/colors.json')
